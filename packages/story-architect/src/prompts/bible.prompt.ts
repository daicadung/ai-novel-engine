...
export function buildCoreBiblePrompt(input: StoryArchitectInput): LlmMessage[] {
  const systemPrompt = `You are an expert Story Architect. Generate the Core World Foundation in JSON.
...
export function buildCharactersPrompt(input: StoryArchitectInput, coreBibleText: string): LlmMessage[] {
  const systemPrompt = `You are an expert Story Architect. Given the Core World Foundation, generate Factions and Characters in JSON.
Output ONLY valid JSON matching this exact structure:
{
  "factions": [
...
export function buildElementsPrompt(input: StoryArchitectInput, coreBibleText: string, charactersText: string): LlmMessage[] {
  const systemPrompt = `You are an expert Story Architect. Given the Core World and Characters, generate Locations, Items, Abilities, and Plot Threads in JSON.
Output ONLY valid JSON matching this exact structure:
{
  "locations": [
